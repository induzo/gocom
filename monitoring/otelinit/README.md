...
- [func InitMetricProvider(ctx context.Context, serviceName string, options ...metric.ProviderOptionFunc) (func() error, error)](<#func-initmetricprovider>)
...
- [func StartMetric(ctx context.Context, conf *Config) (func(ctx context.Context) error, error)](<#func-startmetric>)
...
<details><summary>Example (Discard Metrics)</summary>
<p>
