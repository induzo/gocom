...
```go
import "github.com/triple-a/gocom/http/health"
```
...
## type [CheckConfig](<https://github.com/triple-a/gocom/blob/main/http/health/health.go#L45-L49>)
...
<a name="CheckError"></a>
## type [CheckError](<https://github.com/triple-a/gocom/blob/main/http/health/health.go#L35-L38>)
...
### func \(\*CheckError\) [Error](<https://github.com/triple-a/gocom/blob/main/http/health/health.go#L40>)
...
<a name="Health"></a>
## type [Health](<https://github.com/triple-a/gocom/blob/main/http/health/health.go#L58-L60>)
...
<a name="NewHealth"></a>
### func [NewHealth](<https://github.com/triple-a/gocom/blob/main/http/health/health.go#L66>)
...
### func \(\*Health\) [Handler](<https://github.com/triple-a/gocom/blob/main/http/health/health.go#L98>)
...
### func \(\*Health\) [RegisterCheck](<https://github.com/triple-a/gocom/blob/main/http/health/health.go#L88>)
...
<a name="Option"></a>
## type [Option](<https://github.com/triple-a/gocom/blob/main/http/health/health.go#L63>)
...
<a name="WithChecks"></a>
### func [WithChecks](<https://github.com/triple-a/gocom/blob/main/http/health/health.go#L79>)
...
<a name="Response"></a>
## type [Response](<https://github.com/triple-a/gocom/blob/main/http/health/health.go#L52-L55>)
...
## type [TimeoutError](<https://github.com/triple-a/gocom/blob/main/http/health/health.go#L25-L28>)
...
### func \(\*TimeoutError\) [Error](<https://github.com/triple-a/gocom/blob/main/http/health/health.go#L30>)
